...
exports.AssignmentsModule = AssignmentsModule = __decorate([
    (0, common_1.Module)({ controllers: [assignments_controller_1.AssignmentsController, assignments_controller_1.SubmissionsController], providers: [assignments_service_1.AssignmentsService], exports: [assignments_service_1.AssignmentsService] })
], AssignmentsModule);
